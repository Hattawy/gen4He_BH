...
public:
    ...
    virtual double   Moh_PHI_H(const TLorentzVector k0, const TLorentzVector k1, const TLorentzVector p1);
...
double SpecsGEO::Moh_PHI_H(const TLorentzVector k0, const TLorentzVector k1, const TLorentzVector p1)
{
     float PHI_h= 0.;
     float TODEG= 180./TMath::Pi();
     TLorentzVector GammaStar4Vector = k0 - k1;
     TVector3 LeptonicPlane = (k0.Vect()).Cross(k1.Vect());
     TVector3 HadronicPlane = (p1.Vect()).Cross(GammaStar4Vector.Vect());

     PHI_h = LeptonicPlane.Angle(HadronicPlane)*TODEG;
     if(LeptonicPlane.Dot(p1.Vect())<0.)  PHI_h = 360.0 - PHI_h;
